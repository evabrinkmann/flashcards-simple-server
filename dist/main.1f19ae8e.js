...
var inputQuestion = document.querySelector('[name="question"]');
var inputAnswer = document.querySelector('[name="answer"]');
var buttonCreate = document.querySelector('[data-js="create"]');
var buttonRead = document.querySelector('[data-js="read"]');
var buttonUpdate = document.querySelector('[data-js="update"]');
var buttonDelete = document.querySelector('[data-js="delete"]');
